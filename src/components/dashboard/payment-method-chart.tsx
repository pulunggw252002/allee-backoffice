...
import { CHART_COLORS, CHART_HEIGHT, PAYMENT_METHOD_LABEL } from "@/lib/constants";
import type { PaymentMethodRow } from "@/lib/api/reports";

export function PaymentMethodChart({ data }: { data: PaymentMethodRow[] }) {
